...
enzywizard-mut-integrate -i examples/wt_input/mut_clean_report_1ZG4_WT_to_1ZG6_S70G.json -w examples/wt_input/ -m examples/mut_input/ -wo examples/wt_output/ -mo examples/mut_output/
...
1. A shared mut-integrate JSON report
   ...
   - "mutant_integrated_graph"
     ...
     - "is_at_mutation_site"
       - Data type: boolean
       - Description: The field 'is_at_mutation_site' indicates whether the residue ('residue': http://purl.obolibrary.org/obo/GENO_0000782) is located at an amino acid substitution site ('amino acid substitution': http://purl.obolibrary.org/obo/SO_0001606).
