...
def add_mut_integrate_parser(parser: ArgumentParser) -> None:
    ...
    parser.add_argument("--strict", dest="strict", action="store_true",help="Enable strict mode requiring all 11 supported side report types and all node fields (default: Disabled).")
    parser.set_defaults(strict=False)
    parser.set_defaults(func=run_mut_integrate)


def run_mut_integrate(args: Namespace) -> None:
    success = run_mut_integrate_service(
